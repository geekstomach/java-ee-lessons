 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://service.geekstomach.com/", wsdlLocation = "http://localhost:8080/webapp/ProductService/ProductService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICE_QNAME = new QName("http://service.geekstomach.com/", "ProductService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webapp/ProductService/ProductService?WSDL");
    ...
    public ProductServiceWs getProductServicePort() {
        return super.getPort(new QName("http://service.geekstomach.com/", "ProductServicePort"), ProductServiceWs.class);
    }
     ...
     */
    @WebEndpoint(name = "ProductServicePort")
    public ProductServiceWs getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.geekstomach.com/", "ProductServicePort"), ProductServiceWs.class, features);
    }
